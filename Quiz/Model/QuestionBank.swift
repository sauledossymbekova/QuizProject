...
class QuestionBank {
    ...
    init () {
        ...
        */
        listlevel1.append(Question (image: "flag1", questionText: "Величины смежных углов пропорциональны числам 5 и 7. Найдите разность между этими углами.", choiceA: "30'", choiceB: "70'", choiceC: "105'", choiceD: "5'", answer: 1))
        listlevel1.append(Question (image: "flag2", questionText: "Катеты прямоугольного треугольника равны 6 и 8. Чему равна гипотенуза треугольника?", choiceA: "100", choiceB: "16", choiceC: "10", choiceD: "46", answer: 3))
        listlevel1.append(Question (image: "flag3", questionText: "По теореме Пифагора квадрат гипотенузы равен сумме квадратов катетов. Подставив числовые данные, получаем ответ.", choiceA: "Ромб", choiceB: "Квадрат", choiceC: "Окружность", choiceD: "Круг", answer: 3))
        listlevel2.append(Question (image: "flag4", questionText: "Если угол при вершине равнобедренного треугольника равен 40°, то углы при основании равны:", choiceA: "60'60'", choiceB: "70'70'", choiceC: "70'50'", choiceD: "60'80'", answer: 2))
        listlevel2.append(Question (image: "flag5", questionText: "При пересечении двух параллельных прямых секущей сумма односторонних углов равна:", choiceA: "90", choiceB: "180", choiceC: "45", choiceD: "60", answer: 2))
        listlevel2.append(Question (image: "flag6", questionText: "Центральный угол опирается на дугу 100°. Чему равен вписанный угол, опирающийся на ту же дугу?", choiceA: "100’", choiceB: "50’", choiceC: "25’", choiceD: "150’", answer: 2))
